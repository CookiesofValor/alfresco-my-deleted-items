...
2. Use the Alfresco [Module Management Tool](http://wiki.alfresco.com/wiki/Module_Management_Tool) to install the modules in your Alfresco and Share WAR files:
        ...
        java -jar alfresco-mmt.jar install $ALFRESCO_HOME/amps/my-deleted-items-alfresco-module-1.0.0.amp $TOMCAT_HOME/webapps/alfresco.war -force
        java -jar alfresco-mmt.jar install $ALFRESCO_HOME/amps_share/my-deleted-items-share-module-1.0.0.amp $TOMCAT_HOME/webapps/share.war -force
